      ...
      <div className="min-h-screen bg-paper flex flex-col items-center justify-center p-6 font-sans text-ink">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center border-t-4 border-brown-dark">
          <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden border-2 border-brown-dark bg-white flex items-center justify-center">
            <img 
              src="https://bangla.evertechdigital.com/wp-content/uploads/2026/03/bangla-logo.png" 
              alt="Nurul's Bangla Cuisine Logo" 
              className="w-full h-full object-cover object-center"
              referrerPolicy="no-referrer"
            />
          </div>
          <h1 className="text-3xl font-serif italic text-brown-light mb-2">Nurul's Table</h1>
          <p className="text-gray-600 mb-8 text-[11px] uppercase tracking-[2px]">Authentic Bangla Cuisine in Vancouver</p>
    ...
    <div className="min-h-screen bg-paper text-ink font-sans flex flex-col md:grid md:grid-cols-[240px_1fr] overflow-hidden">
      ...
      <aside className="bg-brown-dark text-white py-10 flex flex-col md:h-screen md:overflow-y-auto">
        <div className="px-8 pb-10 border-b border-white/10 hidden md:block">
          ...
          <h1 className="font-serif text-2xl italic text-brown-light leading-tight">Nurul's Table</h1>
          <p className="text-[11px] uppercase tracking-[2px] opacity-80 mt-2">Authentic Bangla</p>
        </div>
        ...
        <div className="px-4 pb-4 flex justify-between items-center md:hidden">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-serif text-xl italic text-brown-light">Nurul's Table</h1>
